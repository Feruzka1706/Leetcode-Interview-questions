...
//
        ...
        DoubleLinkedListCustomStackImpl<Integer> myStack2 = new DoubleLinkedListCustomStackImpl<>();

        //System.out.println("Deleting top element from stack: " + myStack2.pop());
        //System.out.println("Retrieving top element from stack: " + myStack2.peek());
        //System.out.println("Is My stack empty: "+ myStack2.isEmpty());
        myStack2.push(2);
        ...
        myStack2.push(17);
        System.out.println(myStack2.peek());
        System.out.println("Searching index of element: " +myStack2.search(17));
        myStack2.printNodes();
        System.out.println("Popping the last element from stack: "+ myStack2.pop());
        myStack2.printNodes();
        System.out.println("After popping last element: "+ myStack2.peek());
        myStack2.push(100);
